...
{block name="content"}
    <form action="{if $booking->getId()}{path_for name="events_storebooking_edit" data=["id" => $booking->getId()]}{else}{path_for name="events_storebooking_add"}{/if}" method="post" id="modifform">
        <div class="bigtable">
