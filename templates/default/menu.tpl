...
{if $login->isAdmin() or $login->isStaff()}
            ...
            <li{if $cur_route eq "events_activity"} class="selected"{/if}><a href="{path_for name="events_activity" data=["action" => {_T string="add" domain="routes"}]}">{_T string="New activity" domain="events"}</a></li>
{/if}
        </ul>
