...
É possível fazer reservas para cada evento. Como já mencionamos, membros simples
e gestores de grupos terão acesso limitado aos eventos de seus respectivos
grupos, ou seja, aos eventos que não são restritos a um grupo.
